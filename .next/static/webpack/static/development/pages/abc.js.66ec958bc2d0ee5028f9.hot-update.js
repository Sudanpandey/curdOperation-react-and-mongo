...
var index = function index() {
  ...
  var addData = function addData(values) {
    try {
      axios__WEBPACK_IMPORTED_MODULE_5___default.a.post("http://localhost:3000", values);
      getData();
    } catch (error) {
      console.log(error);
    }
  ...
  var deleteData = function deleteData(name) {
    try {
      axios__WEBPACK_IMPORTED_MODULE_5___default.a["delete"]("http://localhost:3000?name=".concat(name));
      getData();
    } catch (error) {
      console.log(error);
    }
...
//# sourceMappingURL=abc.js.66ec958bc2d0ee5028f9.hot-update.js.map