...
var _jsxFileName = "/home/lewin/crud-operation-mongo/pages/index.jsx";
...
const formValidationSchema = yup__WEBPACK_IMPORTED_MODULE_1__["object"]().shape({
  ...
  mobile: yup__WEBPACK_IMPORTED_MODULE_1__["string"]().min(2, "Too Short!").max(25, "Too Long!").min(6, "Phoneno has to be longer than 6 characters!").required("Valid password  is required"),
...
const index = () => {
  ...
  const {
    0: selectedStudent,
    1: setSelectedStudent
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(initialValues); // For View data
  ...
  const addData = async values => {
    try {
      await axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("http://localhost:3000", values);
      getData();
    } catch (error) {
      console.log(error);
    }
  ...
  const deleteData = async name => {
    try {
      await axios__WEBPACK_IMPORTED_MODULE_3___default.a.delete(`http://localhost:3000?name=${name}`);
      getData();
    } catch (error) {
      console.log(error);
    }
  ...
  const putData = async values => {
    try {
      delete values._id;
      await axios__WEBPACK_IMPORTED_MODULE_3___default.a.put(`http://localhost:3000?name=${values.name}`, values);
...
module.exports = __webpack_require__(/*! /home/lewin/crud-operation-mongo/pages/index.jsx */"./pages/index.jsx");
